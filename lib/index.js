...
const defineEntry = (doPolyfill, entryFilename) => ({ entry: doPolyfill ? [ POLYFILLS_MODULE, entryFilename ] : [ entryFilename ] });
...
const rulesForScripts = (devMode, nodeModulesToBabel, doPolyfill, skipLinting, eslintConfigPath, babelConfigPath, tsConfigPath) => ([
    skipLinting ? {} : {
        test: /\.(tsx?|jsx?)$/,
    ...
    },
    {
        ...
        options: {
            ...
            compilerOptions: {
                ...
                module: doPolyfill ? 'commonjs' : 'es6',
            },
        },
    },
    {
...
const generateConfig = ({
    ...
    ...defineEntry(doPolyfill, entryFile),
    ...defineOutput(scriptOutputFilename),
    ...commonSettings(devMode, aliases),
    ...devServerSettings(devMode, useHttps, allowCors),
    module: {
        rules: [
            ...rulesForScripts(devMode, nodeModulesToBabel, doPolyfill, skipLinting, eslintConfigPath, babelConfigPath, tsConfigPath),
