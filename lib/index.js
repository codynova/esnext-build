...
// TO DO:
// * fix tsconfig.json include paths (OR move tsconfig.json into example repo???)
...
const rulesForScripts = (devMode, nodeModulesToBabel, usePolyfills, useLinting, eslintConfigPath, babelConfigPath, tsConfigPath) => ([
    !useLinting ? {} : {
        test: /\.(tsx?|jsx?)$/,
...
const generateConfig = ({
    ...
    module: {
        rules: [
            ...rulesForScripts(devMode, nodeModulesToBabel, usePolyfills, useLinting, eslintConfigPath, babelConfigPath, tsConfigPath),
